...
// ディレクトリ定義
define( 'ROOT_DIR', '/home/newkhi/www_minami/trunk' );			// 本番用に変更が必要
...
const SESSION_NAME      = 'newkhi_prod';
const SESSION_URL       = '/newkhi/';

// フラグ系定義
const DISP_GROUP_NAME   = false;		// [index] 教室リストのグループ名表示フラグ（ 時計台・東京オフィスは false ）
